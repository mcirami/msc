...
?>
	...
	<!--	<div class="three_column_section">
		...
		<div class="skills_section">
			<div class="container">
				<h2><span class="underline">Skills</span> <span class="red">&</span> Speciality</h2>
				<div class="two_column_section full_width">
					<div class="column">
						...
						<div class="column_content">
                            ...
                            <p>The interface design should be just that, a design, not decoration. It should enhance the content, not distract from it. Their should be a good balance between a users needs and business goals.</p>
                            <p>Following solid design principles and patterns while at the same time focusing on the most essential elements. Keeping decorations and ornaments to a minimum.</p>
                            <p>A design should be timeless, not too trendy. Simplicity is the absolute key to staying on trend and at the same time being timeless.</p>
                            <h4>Common Design Principles</h4>
                            <ul>
                                <li>
                                    <h5>Pre-Design</h5>
					...
					<div class="column">
						...
						<div class="column_content">
                            ...
                            <h4>Front-End</h4>
                            <p>I have extensive experience with efficient, maintainable and scalable front-end architecture. This is achieved by using the latest version of HTML, CSS, Javascript and JQuery.</p>
                            <p>To streamline my workflow I've used a few different frameworks and preprocessors.</p>
                            <ul>
                                <li>
                            ...
                            <h4>Back-End</h4>
                            <p>As far as a back-end framework, Wordpress is my number one choice. I have the most experience with this CMS and it is very flexible and customizable.</p>
                            <ul>
                                <li>
                            ...
                            <p>Most recently I have been learning and applying the Laravel framework. This is one of the newest technologies that has a good balance between between modern practices and simplicity.</p>
                            <p>Again, depending on the project, I think Laravel will become the number one framework to integrate in my developing.</p>
                            <h4>Hosting</h4>
                            <p>Along with getting your site designed and developed I will also handle the hosting if need be.</p>
                            ...
                            <a href="/contact">Ask me for a free quote</a>
						</div>
					</div><!-- column -->
				</div>
